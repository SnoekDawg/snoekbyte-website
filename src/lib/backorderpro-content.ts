...
export const BACKORDERPRO_SHOWCASE_IMAGES = [
  ...
  '/images/backorderpro/ai-advice.png',
  ...
  nl: {
    ...
    showcase: {
      ...
      items: [
        ...
        { title: 'AI-advies voor een soepele afhandeling', text: 'Afhankelijk van je plan vat BackorderPRO de vraag samen en geeft concrete aanbevelingen \u2014 wat bij te bestellen, waar je levertijden moet herzien en welke backorders je in de gaten moet houden.' },
  ...
  en: {
    ...
    showcase: {
      ...
      items: [
        ...
        { title: 'AI advice for smooth handling', text: 'Depending on your plan, BackorderPRO summarises demand and suggests concrete actions \u2014 what to restock, where to revise lead times and which backorders to watch.' },
  ...
  de: {
    ...
    showcase: {
      ...
      items: [
        ...
        { title: 'KI-Empfehlungen f\u00fcr reibungslose Abwicklung', text: 'Je nach Plan fasst BackorderPRO die Nachfrage zusammen und schl\u00e4gt konkrete Aktionen vor \u2014 was nachzubestellen ist, wo Lieferzeiten anzupassen sind und welche Nachbestellungen du im Blick behalten solltest.' },
  ...
  fr: {
    ...
    showcase: {
      ...
      items: [
        ...
        { title: 'Conseils IA pour un traitement fluide', text: 'Selon votre plan, BackorderPRO r\u00e9sume la demande et propose des actions concr\u00e8tes \u2014 quoi r\u00e9approvisionner, o\u00f9 revoir les d\u00e9lais et quelles commandes en attente surveiller.' },
  ...
  es: {
    ...
    showcase: {
      ...
      items: [
        ...
        { title: 'Consejos de IA para una gesti\u00f3n sin fricci\u00f3n', text: 'Seg\u00fan tu plan, BackorderPRO resume la demanda y propone acciones concretas \u2014 qu\u00e9 reponer, d\u00f3nde revisar los plazos y qu\u00e9 pedidos pendientes vigilar.' },
  ...
  pl: {
    ...
    showcase: {
      ...
      items: [
        ...
        { title: 'Porady AI dla p\u0142ynnej obs\u0142ugi', text: 'W zale\u017cno\u015bci od planu BackorderPRO podsumowuje popyt i proponuje konkretne dzia\u0142ania \u2014 co uzupe\u0142ni\u0107, gdzie zrewidowa\u0107 czasy dostawy i kt\u00f3re zam\u00f3wienia oczekuj\u0105ce obserwowa\u0107.' },
  ...
  cs: {
    ...
    showcase: {
      ...
      items: [
        ...
        { title: 'AI doporu\u010den\u00ed pro hladk\u00e9 vy\u0159izov\u00e1n\u00ed', text: 'Podle va\u0161eho plánu BackorderPRO shrne popt\u00e1vku a navrhne konkr\u00e9tn\u00ed kroky \u2014 co doobjednat, kde upravit dodac\u00ed lh\u016fty a kter\u00e9 nevy\u0159\u00edzen\u00e9 objedn\u00e1vky sledovat.' },
  ...
  sv: {
    ...
    showcase: {
      ...
      items: [
        ...
        { title: 'AI-r\u00e5d f\u00f6r smidig hantering', text: 'Beroende p\u00e5 din plan sammanfattar BackorderPRO efterfr\u00e5gan och f\u00f6resl\u00e5r konkreta \u00e5tg\u00e4rder \u2014 vad som ska fyllas p\u00e5, var ledtider beh\u00f6ver ses \u00f6ver och vilka restorder att bevaka.' },
