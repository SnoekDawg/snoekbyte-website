...
const BELCO_SHOP_ID = '4yBozzvJJ7LvGtQ4s';

export function BelcoChat() {
  return (
    <>
      <Script id="belco-config" strategy="afterInteractive">
        {`window.belcoConfig = { shopId: '${BELCO_SHOP_ID}' };`}
      </Script>
      <Script id="belco-loader" strategy="afterInteractive">
