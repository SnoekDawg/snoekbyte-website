...
export function CTA() {
  ...
  const trustBadges = locale === 'en'
    ? [
        { icon: 'lock', label: 'GDPR Compliant' },
        { icon: 'check', label: 'Free During Beta' },
        { icon: 'chat', label: 'Support within 48h' },
      ]
    : [
        { icon: 'lock', label: 'GDPR Compliant' },
        { icon: 'check', label: 'Gratis Tijdens Beta' },
        { icon: 'chat', label: 'Support binnen 48u' },
      ];
  ...
  return (
    <section className="py-20 lg:py-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        {/* Trust badges - No more "Shopify Verified" or "24/7 Support" */}
